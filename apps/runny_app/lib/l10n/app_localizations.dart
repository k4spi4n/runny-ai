...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _fallbackStrings = {
    'en': {
      ...
      'edit': 'Edit',
      'manual_workout_create_title': 'Add personal schedule',
      ...
      'manual_workout_add_tooltip': 'Add personal schedule',
      ...
      'pace_unit': 'min/km',
      'pace_calculation_pace': 'Use pace',
      'pace_calculation_duration': 'Use duration',
      ...
      'manual_workout_pace_invalid':
          'Please enter a valid pace, for example 5:30.',
      'manual_workout_save_btn': 'Save workout',
      'manual_workout_update_btn': 'Update workout',
      'manual_workout_created': 'Personal schedule saved.',
      ...
      'manual_workout_delete_confirm':
          'Are you sure you want to delete this personal schedule? This action cannot be undone.',
      ...
      'source_manual': 'Self-proposed',
      'source_ai': 'AI-proposed',
      'minutes_short': 'min',
    ...
    'vi': {
      ...
      'edit': 'Sửa',
      'manual_workout_create_title': 'Thêm lịch cá nhân',
      'manual_workout_edit_title': 'Sửa buổi tập',
      'manual_workout_subtitle':
          'Tự lên một buổi tập và giữ nó trong cùng lịch tập.',
      'manual_workout_add_tooltip': 'Thêm lịch cá nhân',
      ...
      'pace_unit': 'phút/km',
      'pace_calculation_pace': 'Tính theo pace',
      'pace_calculation_duration': 'Tính theo thời lượng',
      ...
      'manual_workout_pace_invalid': 'Vui lòng nhập pace hợp lệ, ví dụ 5:30.',
      'manual_workout_save_btn': 'Lưu buổi tập',
      'manual_workout_update_btn': 'Cập nhật buổi tập',
      'manual_workout_created': 'Đã lưu lịch cá nhân.',
      ...
      'manual_workout_delete_confirm':
          'Bạn có chắc muốn xóa lịch cá nhân này? Thao tác này không thể hoàn tác.',
      'manual_workout_schema_missing':
          'Cơ sở dữ liệu chưa được cập nhật cho buổi tập thủ công. Vui lòng chạy migration Supabase mới nhất rồi thử lại.',
      'source_manual': 'Tự đề xuất',
      'source_ai': 'AI đề xuất',
      'minutes_short': 'phút',
