...
void main() {
  group('UnsignedTextInputFormatter tests', () {
    ...
    test('strips Vietnamese accents and converts them to unsigned characters', () {
      const oldValue = TextEditingValue.empty;
      const newValue = TextEditingValue(
    ...
    test('removes space and emoji characters and adjusts cursor selection', () {
      ...
      expect(result.selection.baseOffset, 21); // 😊 is represented by 2 code units, ' ' is 1. Wait, let's verify.
    });

    test('adjusts selection correctly when characters are removed in the middle', () {
